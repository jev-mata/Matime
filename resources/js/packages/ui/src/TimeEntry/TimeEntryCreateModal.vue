...
<template>
  <DialogModal closeable max-width="5xl" :show="show" @close="show = false" >
    <template #title>
          ...
          <div class="space-y-2 mt-1 flex flex-col">
            ...
            <div class="text-sm flex space-x-1">
              <InformationCircleIcon
                class="w-4 text-text-quaternary"
              ></InformationCircleIcon>
        ...
        <div class="">
          ...
          <div class="flex flex-col items-center space-y-2 mt-1">
            ...
            <DatePicker
              v-model="localStart"
              tabindex="1"
              class="text-xs text-text-tertiary max-w-28 px-1.5 py-1.5 dark:border-[#303F61] cursor-pointer dark:bg-[#0C101E] hover:dark:bg-[#303F61] hover:dark:text-[#BFC7D6] dark:text-[#636E88]"
            ></DatePicker>
          </div>
        </div>
        <div class="">
