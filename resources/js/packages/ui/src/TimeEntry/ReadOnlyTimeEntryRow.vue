    ...
    <div class="hover:border-y  dark:border-[#3F4961] transition min-w-0  dark:bg-[#171E31]" data-testid="time_entry_row"
        ...
        <MainContainer class="min-w-0 opacity-40">
            <div class="grid sm:grid-cols-8 md:grid-cols-8 xl:grid-cols-8 2xl:grid-cols-10 items-center py-2 group">
                ...
                <!-- Project/Task Badge -->
                <div class="px-2 w-full 2xl:col-span-3 xl:col-span-5 md:col-span-5 sm:col-span-5 bg-secondary min-w-0">
                    <ProjectBadge :color="selectedProjectColor" :border="false" tag="button"
                        ...
                        <div class="flex lg:space-x-1 min-w-0">
                            ...
                            <div v-if="currentTask"
                                class="min-w-0 shrink text-xs lg:text-sm truncate    text-text-primary text-base">
                                {{ currentTask.name }}
                            </div>
                        </div>
                    </ProjectBadge>
