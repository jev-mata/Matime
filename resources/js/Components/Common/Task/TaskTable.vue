...
const sortedTasks = computed(() => {
  ...
  return [...props.tasks].sort((a, b) => collator.compare(a.name, b.name));
});
</script>
...
<template>
    ...
    <div class="flow-root">
        <div class="inline-block min-w-full align-middle">
            <div data-testid="task_table" role="table" class="grid min-w-full" style="
                ...
                <div v-if="tasks.length === 0" class="col-span-5 py-24 text-center">
                    ...
                    <SecondaryButton v-if="canCreateTasks()" :icon="PlusIcon" @click="createTask = true">Create your
                        First Task
                    </SecondaryButton>
                </div>
