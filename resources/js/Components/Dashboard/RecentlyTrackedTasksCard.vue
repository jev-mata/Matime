...
<template>
    <DashboardCard title="Recent Time Entries" :icon="CheckCircleIcon" class="dark:text-[#7D88A1]  hover:dark:text-[#BFC7D6] ">
        <div v-if="isLoading" class="flex justify-center items-center h-40  dark:text-[#7D88A1]">
            <LoadingSpinner />
        </div>
        ...
        <div
            v-else
            class="text-center flex flex-1 justify-center items-center  dark:text-[#7D88A1] border-b dark:border-[#13192B] dark:bg-[#13192B] bg-gray-100">
            <div>
                <PlusCircleIcon
        ...
        <div
            ...
            class="text-center flex flex-1 justify-center items-center text-sm  dark:text-[#7D88A1] border-b dark:border-[#13192B] dark:bg-[#13192B]  bg-gray-100">
            <div>
                <PlusCircleIcon
                    class="w-8 text-icon-default inline pb-2"></PlusCircleIcon>
                <h3 class=" font-semibold">Add more tasks</h3>
