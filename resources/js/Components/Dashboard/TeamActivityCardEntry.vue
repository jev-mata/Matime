            ...
            <div class="flex justify-between">
                ...
                <div
                    ...
                    <span
                        ...
                        <span
                            class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#77D36F] opacity-75"></span>
                        <span
                            class="relative inline-flex rounded-full h-2 w-2 bg-[#77D36F]"></span>
                    </span>
                    <span
                        class="text-[#77D36F] font-medium text-sm block pb-0.5">
                        working
                    </span>
                </div>
            </div>
